import { BaseColDefOptionalDataParams, ValueFormatterParams, ValueParserParams } from "ag-grid-community/dist/lib/entities/colDef";
export declare type ValueParserLiteParams<TData, TValue> = Omit<ValueParserParams<TData, TValue>, 'data' | 'node' | 'oldValue'>;
export interface ValueParserLiteFunc<TData, TValue> {
    (params: ValueParserLiteParams<TData, TValue>): TValue | null | undefined;
}
export declare type ValueFormatterLiteParams<TData, TValue> = Omit<ValueFormatterParams<TData, TValue>, 'data' | 'node'>;
export interface ValueFormatterLiteFunc<TData, TValue> {
    (params: ValueFormatterLiteParams<TData, TValue>): string;
}
export declare type DataTypeCheckerParams<TData, TValue> = Omit<BaseColDefOptionalDataParams<TData, TValue>, 'data' | 'node'> & {
 ...
 */
export declare type BaseCellDataType = 'text' | 'number' | 'boolean' | 'date' | 'dateString' | 'object';
