...
export declare const _: {
    ...
    isUserSuppressingKeyboardEvent(gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, rowNode: import("ag-grid-community/dist/lib/main").IRowNode<any>, column: import("ag-grid-community/dist/lib/main").Column<any>, editing: boolean): boolean;
    isUserSuppressingHeaderKeyboardEvent(gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, headerRowIndex: number, column: import("ag-grid-community/dist/lib/main").Column<any> | import("ag-grid-community/dist/lib/main").ColumnGroup): boolean;
    ...
    createIcon(iconName: string, gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, column: import("ag-grid-community/dist/lib/main").Column<any> | null): Element;
    createIconNoSpan(iconName: string, gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, column?: import("ag-grid-community/dist/lib/main").Column<any> | null | undefined, forceCreate?: boolean | undefined): Element | undefined;
    iconNameClassMap: {
        [key: string]: string;
    };
    ...
    bindCellRendererToHtmlElement(cellRendererPromise: import("ag-grid-community/dist/lib/utils/promise").AgPromise<import("ag-grid-community/dist/lib/main").ICellRendererComp<any>>, eTarget: HTMLElement): void;
    ...
    getAriaSortState(sortDirection: import("ag-grid-community/dist/lib/main").SortDirection | "mixed"): AriaUtils.ColumnSortState;
